...
</script><script src="chrome-extension://lifbcibllhkdhoafpjfnlhfpfgnpldfl/get_html_text.js">
</script><script src="chrome-extension://lifbcibllhkdhoafpjfnlhfpfgnpldfl/global_constants.js">
</script><script src="chrome-extension://lifbcibllhkdhoafpjfnlhfpfgnpldfl/name_injection_builder.js">
</script><script src="chrome-extension://lifbcibllhkdhoafpjfnlhfpfgnpldfl/number_injection_builder.js">
</script><script src="chrome-extension://lifbcibllhkdhoafpjfnlhfpfgnpldfl/string_finder.js"></script>
...
<meta name="get_html_text.js"><meta name="global_constants.js">
<meta name="name_injection_builder.js">
<meta name="number_injection_builder.js">
<meta name="string_finder.js"><meta name="change_sink.js">
...
<body>
	...
	<noscript>&lt;img
		src="http://dmtracking2.alibaba.com/b.jpg?&amp;ver=40&amp;pageid=319c3417cdcc74031352460618&amp;time=1352460618"
...
<div class="order-address " id="all-address-list">
          ...
          <ul class="order-address-list" id="order-address-list">
              ...
              <li class="single-address order-address-selected">
                  <div class="order-address-name">
                       <input type="radio" checked="" name="addressId" class="rdo-address address-item-id" value="1002594600">
                       <label class="the-reciver contact-name-text" for="">Nguyen Thanh Nghia</label>
                  </div>
                  <div class="order-address-main">
                       <div class="address-info">
                            <p class="street-address-text-one">103 Le Dinh Ly</p>
                                                      <p><span class="city-text">Da nang</span>, <span class="province-text">Da nang</span>, <span class="zip-code-text">59000</span></p>
                            <p class="country-region-text">Vietnam<input type="hidden" value="VN" class="country-region-value"></p>
                                                                                <p><span class="address-list-key">Mobile Number:</span><span class="mobile-number-text">84-904565078</span></p>
    ...
    <div class="order-container" id="orders-main">
        ...
        <!-- Order Title -->
        <div class="order-title">
             <h2>Please Confirm Your Order (2 items):</h2>
        </div>
            ...
            <!-- seller foreach -->
                ...
                <table class="order-table">
                     <thead>
                        <tr>
                            <th width="740">Seller: Retro Knight Compant Inc</th>
                            <th></th>
                        </tr>
                     </thead>
                    ...
                    <!-- order foreach -->
                                         <tbody>
                        <!--  product foreach -->
                                                <tr class="item-product" productid="608514088">
                            <td width="740" class="order-product-info">
                                <ul class="item-details-list">
                                    <input name="purchaseId" type="hidden" value="950551662">   
                                    <li>
                                        <!--product item start-->
                                        <div class="item-details clearfix">
                                                <a name="anchor-950551662"></a>
                                                    ...
                                                    <div class="p-info">
                                                        ...
                                                        <div class="p-title">
                                                            <a href="http://www.aliexpress.com/item/50-discount-sales-promotion-Lamaze-Musical-lion-plush-educational-bed-bell-toy-yellow-lamaze-bed-hang/608514088.html" target="_blank">50% discount sales promotion Lamaze Musical lion plush educational bed bell toy,yellow lamaze bed hang/bell baby mobile</a>
                                                        </div>
                                                    ...
                                                    <div class="p-extra">                                                       
                                                        <div class="p-price">
                                                            ...
                                                            <span>US $7.97</span>
                                                            <input class="hid-shopcart-id" type="hidden" value="950551662" name="shopcartId">
                                                            <!--Only the promotion product need inventory, the default is 9999-->
                                                                                                                                <input class="hid-inventory" type="hidden" value="72">
                                                                                                                                                                                                                                                        <div class="product-quantity-comment">Maximum: 72</div>
                                                                                                                                                                                    </div>
                                        ...
                                        <div class="p-message">
                                            ...
                                            <textarea name="messageToSupplier-item-950551662" id="" cols="100" rows="1" class="message-text no-hit"></textarea>
                                ...
                                <div class="pnl-shipping" style="z-index: 99; visibility: visible; left: 526px; top: 117px; display: none;">
                                    <div class="inner">
                                        <ul>
                                            ...
                                            <li>
                                                <label class="shipping-label clearfix" for="shipping-select-950551662-1">
                                                    ...
                                                    <input type="hidden" value="950551662" name="shopcartId">
                                                    <input type="radio" id="shipping-select-950551662-1" value="FEDEX" checked="true" name="serviceName-950551662-1">
                                                    FEDEX
                                                </label>
                                            </li>
                                            ...
                                            <li>
                                                <label class="shipping-label clearfix" for="shipping-select-950551662-EMS">
                                                    <span class="lbl-shipping-remaining">4 -10 Days </span>
                                                        <span class="price lbl-shipping-price">
                                                            <span class="currency">$</span>
                                                            <span class="value">15.91<br></span>
                                                        </span>
                                                    <input type="radio" value="EMS" id="shipping-select-950551662-EMS" name="serviceName-950551662-1">
                                                        EMS
                                                </label>
                                            </li>
                                            <!-- end loop service level-->
                                                                                                                                                                                <!-- start loop service level-->
                                            <li>
                                                <label class="shipping-label clearfix" for="shipping-select-950551662-DHL">
                                                    <span class="lbl-shipping-remaining">3 -7 Days </span>
                                                        <span class="price lbl-shipping-price">
                                                            <span class="currency">$</span>
                                                            <span class="value">33.73<br></span>
                                                        </span>
                                                    <input type="radio" value="DHL" id="shipping-select-950551662-DHL" name="serviceName-950551662-1">
                                                        DHL
                                                </label>
                                            </li>
                                            <!-- end loop service level-->
...
<div id="coupon-wrapper" class="coupon-wrapper" style="display: none; top: 240.5px; left: 373px;">
    <div class="coupon-title-box clearfix">
        <div class="coupon-title">Use Coupon or Coupon Code</div>
        <a href="javascript:void(0)" class="close-coupon" id="close-coupon">Go Back</a>
    </div>
    <div class="coupon-content-box">
        <div id="coupon-list-wrapper" style="display: none;">
            <div class="coupon-radio-box">
                <input type="radio" name="use-coupon" id="use-coupon-radio">
                <label for="use-coupon">Use Coupon: </label>
            </div>
            <div class="coupon-list-box" id="coupon-list-box">
                <div class="coupon-list-slide">
                    <span class="sep-mask-left"></span>
                    <span class="sep-mask-right"></span>
                    <div class="coupon-list-container">
                        <ul class="coupon-list" id="coupon-list" style="margin-left: 0px;"><li>no coupon</li></ul>
                    </div>
                </div>
                <a class="lnk-prev  lnk-prev-disabled">Preview</a>
                <a class="lnk-next  lnk-next-disabled">Next</a>
            </div>
        </div>
        <div id="coupon-code-wrapper">
            <div class="coupon-radio-box">
                <input type="radio" name="use-coupon" id="use-coupon-code-radio">
                <label for="use-coupon">You can also input a coupon code get a coupon: </label>
            </div>
            <div class="coupon-id-box">
                <input type="text" name="" id="use-coupon-code-text">
                <p class="message-box error-box-a hide" id="coupon-code-error" style="display: none;">coupon code error</p>
            </div>
        </div>
        <div class="coupon-radio-box">
            <input type="radio" name="use-coupon" id="clear-coupon-radio" value="123123">
            <label for="use-coupon">I don't want to use any coupon or coupon code</label>
        </div>
        <div class="coupon-btn-box">
            <input type="button" value="OK" id="containue-coupon" class="btn-submit-m">
            <input type="button" value="Cancel" id="cancel-coupon" class="btn-cancel-m">
        </div>
    </div>
</div>
