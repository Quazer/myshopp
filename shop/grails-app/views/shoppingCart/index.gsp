                ...
                <div id="shoppingcart">
                            ...
                            <table id="table2" cellpadding="5" cellspacing="1" class="cart clear_sc" style="line-height: 15px;
                                ...
                                <tr>
		                            ...
		                            <tr class="item">
		                                <td class="sku">
		                                    ${shoppingCartInstance.product.sku }
		                                </td>
		                                <td class="name">
		                                ...
		                                <td class="total">
		                                   ${CommonUtils.productPrice(shoppingCartInstance.product, shoppingCartInstance.quantity) }
		                                </td>
                                        <td class="remove">
                                            ${shoppingCartInstance.shippingMethod.name } 
                                        </td>
		                                <td class="remove">
